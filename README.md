...
- **Веб-сайт**: http://localhost:8002 (откроется HTML страница)
- **Backend API**: http://localhost:8002/mail_generator (POST запрос)
...
### Для клиентов:
1. Откройте браузер и перейдите на http://localhost:8002
